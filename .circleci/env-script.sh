...
response=$(curl -X POST --url 'https://circleci.com/api/v2/context' -H 'Circle-Token: f7aa3b819623c1cc786dd39bb9e09742c47fea3c' -H 'Content-Type: application/json' -d '{"name":"php-context4","owner":{"id":"5d18d3c7-f8c4-4c5f-a691-b730e67047d3","type":"organization"}}')
echo $response
